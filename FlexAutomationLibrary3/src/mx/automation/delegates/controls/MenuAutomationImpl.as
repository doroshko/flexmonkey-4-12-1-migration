...
package mx.automation.delegates.controls {
    ...
    public class MenuAutomationImpl extends ListAutomationImpl {
        ...
        public function MenuAutomationImpl(obj:Menu) {
            ...
            if (rootMenu == obj) {
                rootMenu.addEventListener(MenuEvent.ITEM_CLICK, menuItemClickHandler, false, EventPriority.DEFAULT + 1, true);
                rootMenu.addEventListener(MenuEvent.MENU_SHOW, menuShowHandler, false, EventPriority.DEFAULT + 1, true);
                rootMenu.addEventListener(MenuEvent.MENU_HIDE, menuHideHandler, false, EventPriority.DEFAULT + 1, true);
            }
        }
         ...
         *  @private
         */
        // orginal automationName function
        /*
        ...
        //MonkeyPatch version of automationName function
        override public function get automationName():String {
            var menuItem:IAutomationObject = associatedMenuItem;

            if (menuItem != null && menuItem.automationName != null) {
                return menuItem.automationName + " Menu";
            } else {
                return super.automationName;
            }
        }
