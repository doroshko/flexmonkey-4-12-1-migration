...
//			return chilArray;
			return [_scroller.viewport, _scroller.horizontalScrollBar, _scroller.verticalScrollBar];
		}
		...
		{		
			...
			switch(index) {
				case 0:
					return _scroller.viewport as IAutomationObject;
				case 1:
					return _scroller.horizontalScrollBar as IAutomationObject;
				default:
					return _scroller.verticalScrollBar as IAutomationObject;
			}
		}
