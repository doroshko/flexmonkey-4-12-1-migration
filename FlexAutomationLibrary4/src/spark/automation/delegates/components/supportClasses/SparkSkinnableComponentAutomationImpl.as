...
//		include "../../../../core/Version.as";
		...
		private var _skinnable:SkinnableComponent;
		...
		override public function getAutomationChildren():Array {
			return _skinnable.skin.getAutomationChildren().filter(function(obj:Object, index:int, array:Array):Boolean {
				return (obj && obj is IAutomationObject);
			});
		}
		
		override public function getAutomationChildAt(index:int):IAutomationObject {
			if (index > this.numAutomationChildren) {
				return null;
			}
