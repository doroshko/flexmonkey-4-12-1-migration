...
package com.gorillalogic.aqadaptor {
    ...
    import com.gorillalogic.aqadaptor.custom.utilities.EnvXMLParser;
    ...
    public class AQEnvironment implements IAutomationEnvironment {
        ...
        public static function sortXMLByAttribute($xml:XML, $attribute:String, $options:Object = null, $copy:Boolean = false):XML {
            ...
            for each (item in $xml.children()) {
                if (item.child("Events")) {
                    for each (var elem:XML in item.child("Events")) {
                        sortXMLByAttribute(elem, "Name");
                    }
                }
        ...
        public function AQEnvironment(source:XML) {
            super();
            var sorted:XML = sortXMLByAttribute(source, "Name");
